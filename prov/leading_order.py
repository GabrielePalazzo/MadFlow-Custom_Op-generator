...
from matrix_1_uux_ttx import Matrix_1_uux_ttx, get_model_param as model_1_uux_ttx
...
tree_level = {
    "1_gg_ttx": (Matrix_1_gg_ttx, model_1_gg_ttx),
    "1_uux_ttx": (Matrix_1_uux_ttx, model_1_uux_ttx),
}

# and the masses of the final states
particle_masses = {
    "1_gg_ttx": ["ZERO", "ZERO", "mdl_MT", "mdl_MT"],
    "1_uux_ttx": ["ZERO", "ZERO", "mdl_MT", "mdl_MT"],
}
